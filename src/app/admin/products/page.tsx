        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-6">
            <div>
              ...
              <p className="text-muted-foreground">Add, edit, or delete items from your store.</p>
            </div>
            <Button asChild className="bg-accent hover:bg-accent/90 w-full md:w-auto">
              <Link href="/admin/products/add"><Plus className="mr-2 h-4 w-4" /> Add New Product</Link>
            </Button>
          </div>
            ...
            <CardHeader className="p-6">
              <div className="flex flex-col md:flex-row justify-between gap-4">
                <div className="relative w-full md:w-96">
                  ...
                  <Input placeholder="Search inventory..." className="pl-10 h-10" />
                </div>
                    ...
                    {MOCK_PRODUCTS.map((product) => (
                      <tr key={product.id} className="bg-white border-b hover:bg-slate-50 transition-colors">
                        <td className="px-6 py-4">
                          <div className="h-12 w-12 rounded-lg bg-slate-100 overflow-hidden relative">
